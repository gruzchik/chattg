...
class OpenAIHelper:
    """
    Helper class for work with ChatGPT
    """

    def __init__(self, config: dict):
        """
        Class initializing with received configs
        :param config: Config library for GPT
        """
    ...
    def get_chat_response(self, chat_id: int, query: str) -> str:
        """
        Request processing from ChatGPT
        :param chat_id: Chat ID
        :param query: Request, that we send to GPT
        ...
        try:
            ...
            if len(self.conversations[chat_id]) > self.config['max_history_size']:
                ...
                try:
                    ...
                    logging.warning("Error while summarising chat history: %s. Popping elements instead...", str(e))
